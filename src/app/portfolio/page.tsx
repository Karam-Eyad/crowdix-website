...
const PROJECTS = [
  ...
  },
  {
    ...
    title: "دكان الريلز",
    category: "Landing Pages",
    desc: "Creative reels agency landing page — bold dark branding with Arabic/English bilingual copy and Instagram Reels focus.",
    status: "LIVE",
    statusStyle: { background: "rgba(34,197,94,0.12)", color: "#4ade80", border: "1px solid rgba(34,197,94,0.3)" },
    img: "/screenshots/dukan-reels.png",
    wide: true,
